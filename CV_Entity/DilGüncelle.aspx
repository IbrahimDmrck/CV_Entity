<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DilGüncelle.aspx.cs" Inherits="CV_Entity.DilGüncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <h3 style="margin: 10px 20px; border: dashed 2px gray; width: 450px; border-radius: 15px; background-color: dimgray">DİL GÜNCELLEME SAYFASI</h3>
        <br />
        ...
        <br />
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-info" Style="margin: 20px 20px" Text="Diil Güncelle" OnClick="Button1_Click" />
