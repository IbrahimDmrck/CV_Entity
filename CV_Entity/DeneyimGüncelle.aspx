<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="DeneyimGüncelle.aspx.cs" Inherits="CV_Entity.DeneyimDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div style="border: solid 4px skyblue; margin: 100px auto; text-align: center; border-radius: 15px; background-color: lightgray;width:650px;height:250px;">
        ...
        <h3 style="margin: 10px 20px; border: dashed 2px gray; width: 450px; border-radius: 15px; background-color: dimgray">DENEYİM GÜNCELLEME SAYFASI</h3>
        <br />
       ...
       <div style="margin-top: 15px;">
        ...
        <br />
        <asp:Button ID="Button1" runat="server" CssClass="btn btn-info" Style="margin: 20px 20px" Text="Deneyim Güncelle" OnClick="Button1_Click" />
